...
public class MultiCompraElectronica_HTTP_PortProxy{
    ...
    public class Descriptor {
        private co.com.rbm.esb.multi.comercio.compra.MultiCompraElectronicaHTTPService _service = null;
        private co.com.rbm.esb.multi.comercio.compra.MultiCompraElectronicaMsgSetPortType _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new co.com.rbm.esb.multi.comercio.compra.MultiCompraElectronicaHTTPService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            _proxy = null;
            _dispatch = null;
            _service = new co.com.rbm.esb.multi.comercio.compra.MultiCompraElectronicaHTTPService();
            initCommon();
        }
        ...
        public co.com.rbm.esb.multi.comercio.compra.MultiCompraElectronicaMsgSetPortType getProxy() {
            return _proxy;
        }
